...
#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#* objective
minimize TIME : t[GRID_MAX];
#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#* objective!

#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#* car
# kinematic car model
param r >= 0; # wheel radius
param L > 0; # axle length

set WHEEL := {'L', 'R'};

# kinematic controls: linear velocity = r (uL + uR) / 2, turning velocity = r / L (uR - uL)
var uL {GRID[0]}; # angular velocity of left wheel
var uR {GRID[0]}; # angular velocity of right wheel

#-- minimum path problem
param q0 {Q}; # start config
param qf {Q}; # goal config
param ulim {WHEEL}; # control limits

subject to T0 : t[0] = 0;
subject to Q0 {i1 in Q} : q[i1, 0] = q0[i1];
subject to TF : t[GRID_MAX] >= t[0];
subject to QF {i1 in Q} : q[i1, GRID_MAX] = qf[i1];
    # start and end goal configuration

subject to UL_LIM {i1 in GRID[0]} : -ulim['L'] <= uL[i1] <= ulim['L'];
subject to UR_LIM {i1 in GRID[0]} : -ulim['R'] <= uR[i1] <= ulim['R'];
    # limit the signed magnitude of the inputs

subject to VX {i1 in GRID[0]} : v[1, i1] = r / 2 * (uR[i1] + uL[i1]) * cos(q[3, i1]);
subject to VY {i1 in GRID[0]} : v[2, i1] = r / 2 * (uR[i1] + uL[i1]) * sin(q[3, i1]);
subject to WZ {i1 in GRID[0]} : v[3, i1] = r / L * (uR[i1] - uL[i1]);
