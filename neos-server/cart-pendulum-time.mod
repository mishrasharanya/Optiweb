...
# state constraints
subject to X0 {i1 in X} : x[i1, 0] = 0;

subject to CART_FINAL : q[1, GRID_MAX] = dist;
subject to PENDULUM_FINAL : q[2, GRID_MAX] = acos(-1);
subject to VEL_FINAL {i1 in Q} : v[i1, GRID_MAX] = 0;

subject to CART {i1 in GRID[0]} : -2*dist <= q[1, i1] <= 2*dist;
subject to PENDULUM {i1 in GRID[0]} : -2*acos(-1) <= q[2, i1] <= 2*acos(-1);

# input constraints
subject to U_CART {i1 in GRID[0]} : -maxForce <= u[1, i1] <= maxForce;
subject to U_PENDULUM {i1 in GRID[0]} : u[2, i1] = 0;

# time constraints
subject to T0 : t[0] = 0;
subject to TF : 0.01 <= t[GRID_MAX];
#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#* cart-pendulum!
