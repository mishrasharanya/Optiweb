...
subject to QF {i1 in Q} : q[i1, GRID_MAX] = if i1 = 1 then acos(-1);
subject to VF {i1 in Q} : v[i1, GRID_MAX] = 0;
subject to Q1 {i1 in GRID[0]} : -2*acos(-1) <= q[1, i1] <= 2*acos(-1);
subject to Q2 {i1 in GRID[0]} : -2*acos(-1) <= q[1, i1] + q[2, i1] <= 2*acos(-1);

# input constraints
subject to U_SHLDR {i1 in GRID[0]} : u[1, i1] = 0;
subject to U_ELBW {i1 in GRID[0]} : -20 <= u[2, i1] <= 20;

# time constraints
subject to T0 : t[0] = 0;
subject to TF : t[GRID_MAX] = 2;
#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#* acrobot!
